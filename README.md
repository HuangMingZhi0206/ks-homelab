...
**Backups:** the state worth saving is `secrets/`, `.env`, `authelia/users_database.yml`, `traefik/acme/`, and the named volumes (`homelab_grafana_data`, `homelab_prometheus_data`, `homelab_authelia_data`).
